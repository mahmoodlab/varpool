...
from var_pool.viz.var_pool_extremes import viz_top_var_proj_patches
...
for risk, patient_id in patient_iter:
    ...
    viz_top_var_proj_patches(model=model,
                             wsi_fpath=wsi_fpath,
                             h5_fpath=h5_fpath,
                             autogen_fpath=args.autogen_fpath,
                             device=device,
